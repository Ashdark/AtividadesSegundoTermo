        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Fornecedores>(entity =>
            {
                ...
                entity.HasIndex(e => e.Cnpj)
                    .HasName("UQ__Forneced__AA57D6B4B1233CE8")
                    .IsUnique();

                entity.HasIndex(e => e.RazaoSocial)
                    .HasName("UQ__Forneced__448779F0D1536B40")
                    .IsUnique();

                entity.HasIndex(e => e.UsuarioId)
                    .HasName("UQ__Forneced__2B3DE7B92775BDFD")
                    .IsUnique();
            ...
            modelBuilder.Entity<Pecas>(entity =>
            {
                ...
                entity.HasIndex(e => e.Codigo)
                    .HasName("UQ__Pecas__06370DAC8CAB06F3")
                    .IsUnique();
            ...
            modelBuilder.Entity<Usuarios>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Usuarios__A9D105342620225A")
                    .IsUnique();
